...
def main():
    ...
    st.subheader('''This application helps to classify the country on the basis
                 of its scio-ecinomic and health factors''')
    ...
    impor = st.text_input('Enter the % of GDP spend on imports')
